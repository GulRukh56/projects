...
//step 1 arrays
const current_users: string[] =["aniqa", "amna", "areeba", "gul", "noor"];
const new_users: string[] =["arif", "ali", "zain", "humza"]


function CheckUsersName(current_users: string[], new_user: string[]): void
  {
